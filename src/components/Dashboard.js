  ...
  <div className="card custom-card h-100">
    <div className="card-body">
      <div className="d-flex align-items-center mb-3">
        <div className={`icon-box bg-${color} text-white rounded-circle p-2 me-3`}>
...
export default function Dashboard() {
  ...
  return (
    <div className="container-fluid p-1 dashboard-container">
      ...
      <Row>
        <div className="col-md-6">
          <Card title="Upcoming Warranty Expiries" icon="calendar-event" color="warning">
            <div style={{ height: '250px' }}>
        ...
        <div className="col-md-6">
          <Card title="Asset Distribution" icon="diagram-3" color="success">
            <div className="text-center mb-3">
              ...
              <div className="small text-muted">Total Distribution Points</div>
            </div>
      ...
      <Row>
        <div className="col-md-6">
          <Card title="Assigned vs Unassigned" icon="person-check" color="primary">
            <div className="text-center mb-2">
        ...
        <div className="col-md-6">
          <Card title="Disposal Summary" icon="trash" color="danger">
            <div className="text-center mb-2">
              ...
              <div className="small text-muted">Total Assets Disposed</div>
            </div>
            <div style={{ height: '180px' }}>
      ...
      <Row>
        <div className="col-12">
          <Card title="Downloadable Reports" icon="download" color="info">
