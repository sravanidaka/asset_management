  ...
  const fetchDisposalRecords = async () => {
    ...
    try {
      ...
      if (error.response?.status === 401) {
        ...
        message.error("Failed to load disposal records: " + (error.message || "Unknown error"));
      }
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <div className="d-flex gap-2">
          <ExportButton
            data={dataSource}
            columns={columns}
            filename="Disposal_Records_Report"
            title="Disposal Records Report"
            reportType="disposal-records"
