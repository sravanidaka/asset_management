...
import { AssetIdsDropdownNew, DepreciationMethodsDropdown } from '../../components/SettingsDropdown';
...
const Financial = () => {
  ...
  const getDynamicColumns = () => {
    ...
    const allPossibleFields = [
      ...
      'useful_life_years', 'monthly_depreciation', 'accumulated_depreciation'
    ];
    ...
    <div className="container-fluid p-1 position-relative" style={{ minHeight: "100vh" }}>
      ...
      >
        <Form layout="vertical" form={form} onFinish={onFinish}>
          ...
          {/* General Ledger Code field commented out as requested */}
